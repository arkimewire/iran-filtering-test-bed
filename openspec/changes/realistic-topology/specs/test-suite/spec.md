...
- **WHEN** simple topology is active
- **THEN** section 1 checks 6 nodes: `iran-client`, `iran-isp`, `iran-ixp`, `iran-backbone`, `internet-srv`, `iran-intranet`

#### Scenario: Health check for realistic topology
- **WHEN** realistic topology is active
- **THEN** section 1 checks all ~15 nodes including `tic-tehran`, `gw-falcon`, `gw-epeg`, `tic-south`, `tic-east`, `tehran-ix`, `tci`, `isp-shatel`, `mob-mci`, `mob-irancell`, `client-tehran`, `client-province`, `internet-srv`, `iran-nin`, `ipm-academic`
